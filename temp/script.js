...
function renderResults(data) {
  ...
  // Knowledge card
  const c = data.card;
  card.innerHTML = renderGoogleCard();;
}
...
function renderGoogleCard() {
  ...
  card.innerHTML = `
    <div style="font-family: arial, sans-serif; max-width:1200px; padding:20px;">
      ...
      <h1 style="font-size:28px;">Tim Cook</h1>
      <div style="color:#70757a;">PDG d'Apple</div>
      ...
      <div style="display:flex; gap:16px; margin-top:20px;">
        ...
        <div style="width:300px;">
          <div style="background:#e8f0fe; padding:16px; border-radius:8px;">
            <div>Âge</div>
            <div style="font-size:22px;">65 ans</div>
          </div>
        </div>
...
window.addEventListener("DOMContentLoaded", () => {
  setupSearchBar("search-input", "home-search-bar", "autocomplete", doSearch);
  setupSearchBar(
    "top-search-input",
    "top-search-bar",
    "top-autocomplete",
